...
def build_solar_analysis(
    *, example_id: str, alternative_id: str, selected_date: str, selected_time: str,
    ...
    return EnvironmentalAnalysis(
        ...
        derived_metrics={"solar_azimuth_degrees": position.azimuth_degrees, "solar_elevation_degrees": position.elevation_degrees, "solar_vector_local_enu": position.solar_vector, "wind_speed_m_s": source_values.get("wind_speed_10m"), "wind_direction_degrees": source_values.get("wind_direction_10m"), "wind_gusts_m_s": source_values.get("wind_gusts_10m"), "air_temperature_c": source_values.get("temperature_2m"), "apparent_temperature_c": source_values.get("apparent_temperature"), "relative_humidity_percent": source_values.get("relative_humidity_2m"), "dew_point_c": source_values.get("dew_point_2m"), "precipitation_mm": source_values.get("precipitation"), "rain_mm": source_values.get("rain"), "showers_mm": source_values.get("showers"), "precipitation_probability_percent": source_values.get("precipitation_probability"), "cloud_cover_percent": source_values.get("cloud_cover"), "cloud_cover_low_percent": source_values.get("cloud_cover_low"), "cloud_cover_mid_percent": source_values.get("cloud_cover_mid"), "cloud_cover_high_percent": source_values.get("cloud_cover_high"), "pressure_msl_hpa": source_values.get("pressure_msl"), "surface_pressure_hpa": source_values.get("surface_pressure"), "direct_normal_irradiance_w_m2": source_values.get("direct_normal_irradiance")},
        units={"solar_azimuth_degrees": "degrees", "solar_elevation_degrees": "degrees", "solar_vector_local_enu": "unitless direction vector", "wind_speed_m_s": "m/s", "wind_direction_degrees": "degrees FROM (meteorological)", "wind_gusts_m_s": "m/s", "air_temperature_c": "°C", "apparent_temperature_c": "°C", "relative_humidity_percent": "%", "dew_point_c": "°C", "precipitation_mm": "mm", "rain_mm": "mm", "showers_mm": "mm", "precipitation_probability_percent": "%", "cloud_cover_percent": "%", "cloud_cover_low_percent": "%", "cloud_cover_mid_percent": "%", "cloud_cover_high_percent": "%", "pressure_msl_hpa": "hPa", "surface_pressure_hpa": "hPa", "direct_normal_irradiance_w_m2": "W/m²"},
