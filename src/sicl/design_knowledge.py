...
SOURCES: tuple[DesignKnowledgeSource, ...] = (
    ...
    DesignKnowledgeSource("BOOK-NEUFERT-ARCHITECTS-DATA", "Architects' Data / Bauentwurfslehre", ["Ernst Neufert", "Johannes Kister"], SourceClass.PROFESSIONAL_GUIDANCE, "BOOK", "en/de", 2024, "Neufert Stiftung / Wiley", edition_or_version="44th edition; edition history preserved", isbn_or_legal_id="978-1-119-87394-5", url="https://www.neufert-stiftung.de/en/bauentwurfslehre", license_status=LicenseStatus.NO_REPRODUCTION, rights_evidence="Foundation and publisher metadata verified; no reproduction or ingestion permission established.", processing_permission_status="METADATA_ONLY", bibliographic_reference="Neufert, Architects' Data / Bauentwurfslehre. Metadata-only controlled pilot.", review_status=ReviewStatus.BIBLIOGRAPHICALLY_VERIFIED),
    DesignKnowledgeSource("BOOK-WHITE-SITE-ANALYSIS", "Site Analysis: Diagramming Information for Architectural Design", ["Edward T. White"], SourceClass.PROFESSIONAL_GUIDANCE, "BOOK", "en", 1983, "Architectural Media", edition_or_version="Illustrated reprint", isbn_or_legal_id="9781928643043", url="https://books.google.com/books/about/Site_Analysis.html?id=m2PRoAEACAAJ", license_status=LicenseStatus.NO_REPRODUCTION, rights_evidence="Public bibliographic metadata verified; no reproduction or ingestion permission established.", processing_permission_status="METADATA_ONLY", bibliographic_reference="White (1983), Site Analysis: Diagramming Information for Architectural Design.", review_status=ReviewStatus.BIBLIOGRAPHICALLY_VERIFIED),
...
ITEMS: tuple[DesignKnowledgeItem, ...] = (
    ...
    DesignKnowledgeItem("ITEM-NEUFERT-DIMENSIONAL-REFERENCE-001", "BOOK-NEUFERT-ARCHITECTS-DATA", KnowledgeItemType.DIMENSIONAL_GUIDANCE, "Referencia dimensional para revisión", "Referencia dimensional metadata-only de Neufert para formular una comprobación de escala, uso y espacio; el valor concreto debe verificarse en una edición aplicable.", "SOURCE_METADATA_ONLY", AuthorityLevel.THEORETICAL, _scopes("edificacion", "espacio", "objeto"), outputs=["dimensional_check_question"], criteria=["scale_review", "applicability_review"], citation_locator="Neufert Stiftung metadata; exact value locator pending", review_status=ReviewStatus.UNDER_REVIEW, limitations=["No contiene valor dimensional reproducido.", "No es requisito legal ni resultado de cumplimiento.", "Requiere evidencia de edición y aplicabilidad."], conditions={"reference_status":"REFERENCE_ONLY","regulatory_status":"NOT_REGULATORY","rights_status":"NO_REPRODUCTION"}, related_item_ids=["ITEM-CHING-SPATIAL-HIERARCHY-001", "ITEM-WHITE-SITE-ANALYSIS-001"]),
    DesignKnowledgeItem("ITEM-NEUFERT-CIRCULATION-REFERENCE-001", "BOOK-NEUFERT-ARCHITECTS-DATA", KnowledgeItemType.DIMENSIONAL_GUIDANCE, "Referencia funcional de circulación", "Referencia funcional metadata-only para revisar circulación y holguras; cualquier medida debe verificarse en la edición y jurisdicción aplicables.", "SOURCE_METADATA_ONLY", AuthorityLevel.THEORETICAL, _scopes("edificacion", "espacio"), outputs=["circulation_reference_question"], criteria=["clearance_review", "functional_relationship"], citation_locator="Neufert Stiftung metadata; exact value locator pending", review_status=ReviewStatus.UNDER_REVIEW, limitations=["No reproduce tabla ni medida protegida.", "No sustituye RNE ni crea Constraint."], conditions={"reference_status":"REFERENCE_ONLY","regulatory_status":"NOT_REGULATORY","rights_status":"NO_REPRODUCTION"}, related_item_ids=["ITEM-CHING-CIRCULATION-ORGANIZATION-001"]),
    DesignKnowledgeItem("ITEM-WHITE-SITE-ANALYSIS-001", "BOOK-WHITE-SITE-ANALYSIS", KnowledgeItemType.DESIGN_QUESTION, "Diagramación de información del sitio", "Referencia estructurada de SiMS-DeI para preguntar qué información del sitio debe organizarse antes de comparar implantaciones; no reproduce diagramas ni prescribe un método único.", "SIMS_DEI_DERIVED_INTERPRETATION", AuthorityLevel.THEORETICAL, _scopes("parcela_sitio", "edificacion", "zona_barrio_sector"), outputs=["site_analysis_question", "context_overlay_question"], criteria=["site_context", "orientation", "access"], citation_locator="Public bibliographic metadata; content locator pending", review_status=ReviewStatus.UNDER_REVIEW, limitations=["No es análisis GIS ni verificación normativa por sí mismo.", "No se presenta como cita literal."], related_item_ids=["ITEM-PREVI-EXPERIMENTAL-HOUSING-CASE-001", "ITEM-NEUFERT-DIMENSIONAL-REFERENCE-001"]),
    DesignKnowledgeItem("ITEM-WHITE-SITE-SEQUENCE-001", "BOOK-WHITE-SITE-ANALYSIS", KnowledgeItemType.DESIGN_QUESTION, "Secuencia de lectura del sitio", "Pregunta de diseño para ordenar contexto, accesos, orientación y relaciones del sitio antes de generar alternativas espaciales.", "SIMS_DEI_DERIVED_INTERPRETATION", AuthorityLevel.THEORETICAL, _scopes("parcela_sitio", "edificacion"), outputs=["site_reading_sequence"], criteria=["context_completeness"], citation_locator="White bibliographic metadata; content locator pending", review_status=ReviewStatus.UNDER_REVIEW, limitations=["No crea datos ni inferencias geográficas faltantes."], related_item_ids=["ITEM-CHING-CIRCULATION-ORGANIZATION-001"]),
) + _apl_items()
